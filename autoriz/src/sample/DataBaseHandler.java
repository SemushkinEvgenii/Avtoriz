...
public class DataBaseHandler {
    ...
    public Connection getDbConnection() throws ClassNotFoundException, SQLException {
        String connectionString = "jdbc:mysql://" + "localHost" + ":" + "3306" + "/" + "detrsad";
    ...
    public ResultSet getUser(Us us) {
        ...
        String select = "SELECT * FROM userdata" + " WHERE login" +
                "=? AND password" + "=?";
        try {
    ...
    public ResultSet  getRoles(Us us){
        ResultSet resSet = null;
        String select = "SELECT ID FROM userdata" + " WHERE Login"+ " =? AND Password" + " =?";
